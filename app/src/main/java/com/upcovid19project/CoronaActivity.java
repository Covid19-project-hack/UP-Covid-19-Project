...
import com.upcovid19project.Adapter.CoronaAdapter;
import com.upcovid19project.Adapter.FAQAdapter;
import com.upcovid19project.Models.Corona;
import com.upcovid19project.Models.FAQ;
import com.upcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Uttar Pradesh").getJSONObject("districtData");
